      ...
      <section>
        <div className={classes.images}>
          ...
          <div className={classes.thinContainer}>
            ...
            <h2>
              "El fanfiction es una forma de amor y gratitud hacia las historias
              y los personajes que más nos han impactado. Es una celebración de
              la imaginación y la creatividad, y una demostración del poder
              duradero de una buena historia para inspirar a otros a soñar y
              crear." ~ Rainbow Rowell
            </h2>
          </div>
        </div>
      </section>
